...
x:0,speed:.2,loose:!0,requestAnimationFrame:!0,dragStartCallback:function(){g()},dragStopCallback:function(a,b){new_slide_index=q.getStep()[0]-1;f.pause_button?g():v();var c=new_slide_index,d=p;p=c;P("afterswipe",[c]);Z(c);L(d,c,!1)},onAfterGlide:function(){q.setStep(p+1,1,!0)}});window.onload=function(){setTimeout(function(){q.reflow()},150);setTimeout(function(){q.reflow()},900)}}function aa(){q&&(q.setStep(p+1,1,!0),q.reflow())}function P(a,b){Q[a]&&Q[a].apply(this,b)}function S(a,c){if(1==c||
...
window[u[v]+"CancelRequestAnimationFrame"];m||(m=function(a){return setTimeout(a,45)},x=clearTimeout);return d});
